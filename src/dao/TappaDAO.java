...
public interface TappaDAO {
    ...
    public List<TappaBean> doRetrieveByCrociera(CrocieraBean crociera) throws SQLException;
    public List<TappaBean> doRetrieveByCrocieraAll(CrocieraBean crociera) throws SQLException;
