...
<nav class="navbar">
  <div class="container">
    <a href="${pageContext.request.contextPath}/home" class="navbar-brand">⚓ S&S Crociere</a>
    <ul class="navbar-nav">
...
<% } else { %>
      <li><a href="${pageContext.request.contextPath}/ordini" class="nav-link">I miei Ordini</a></li>
      <li class="dropdown">
